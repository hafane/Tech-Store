...
const ModalLayout = ({ setIsModal, handleCloseModal, children }: props) => {
	...
	return (
		<>
			<div className="top-0 left-0 right-0 bottom-0 z-50 fixed bg-black/30"></div>
			<div
				ref={ref}
				className="sm:max-w-xl w-full max-h-full py-10 px-16 mx-auto my-auto fixed bg-white rounded-lg z-50 -translate-y-1/2 -translate-x-1/2 top-1/2 left-1/2"
			>
				{children}
